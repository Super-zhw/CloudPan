        ...
        >
            <Alert severity="info" style={{ marginBottom: 10 }}>
                <Typography variant="body2">
                    ...
                    驱动。如需使用，请在目标节点服务器上以和运行 CloudPan
                    相同的用户身份启动 Aria2， 并在 Aria2 的配置文件中开启 RPC
                    服务，
                    <Box component="span" fontWeight="fontWeightBold">
                        Aria2 需要和{mode} CloudPan 进程共用相同的文件系统。
                    </Box>{" "}
                    更多信息及指引请参考文档的{" "}
                    <Link
            ...
            <Collapse in={props.node.Aria2Enabled === "true"}>
                    ...
                    <div className={classes.subStepContent}>
                        ...
                        <Alert severity="info" style={{ marginBottom: 10 }}>
                            <Typography variant="body2">
                                ...
                                CloudPan，这样节点 CloudPan 可以向 Aria2
                                订阅事件通知，下载状态变更处理更及时。当然，如果没有这一流程，节点
                                CloudPan 也会通过轮询追踪任务状态。
                            </Typography>
                        </Alert>
                    </div>
                </div>
                ...
                <div className={classes.subStepContainer}>
                    ...
                    <div className={classes.subStepContent}>
                        <Typography variant={"body2"}>
                            在下方填写{mode} CloudPan 与 Aria2 通信的 RPC
                            服务地址。一般可填写为
                ...
                <div className={classes.subStepContainer}>
                    ...
                    <div className={classes.subStepContent}>
                        <Typography variant={"body2"}>
                            ...
                            <strong>绝对路径</strong>，节点上的 CloudPan
                            进程需要此目录的读、写、执行权限。
                        </Typography>
                        <div className={classes.form}>
                            <Input
